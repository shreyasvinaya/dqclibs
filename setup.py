...
# module's descriptor
module_name = "dqclibs"
ext_name = "dqclibs.pyscflibs"
github_url = "https://github.com/diffqc/dqclibs/tree/master/"
raw_github_url = "https://raw.githubusercontent.com/diffqc/dqclibs/master/"
...
class CMakeBuildExt(build_ext):
    ...
    def construct_extension(self, ext):
        ...
        lib_dir = os.path.join(file_dir, "dqclibs", "libs")
...
setup(
    name=module_name,
    version=vers,
    description='Libraries for DQC',
    url='https://github.com/diffqc/dqclibs/',
